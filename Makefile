...
ftp_direct_upload: publish
	...
	lftp -u $(FTP_USER),$(LFTP_PASSWORD) $(FTP_HOST) -d -e "set ssl:verify-certificate no; set ssl:check-hostname false; set -a; mirror -n --verbose=2 -R $(OUTPUTDIR)/category $(FTP_TARGET_DIR)/category ; quit"
