...
ftp_direct_upload: publish
	...
	lftp -u $(FTP_USER),$(LFTP_PASSWORD) $(FTP_HOST) -e "debug 10; set ssl:verify-certificate no; set ssl:check-hostname false; mirror -n --verbose=2 -R $(OUTPUTDIR)/category $(FTP_TARGET_DIR)/category ; quit"
